...
public class Scheduling {
  ...
  private static String resultsFile = "F:\\Source\\Repos\\OS-labs\\Lab3\\Summary-Results";
    ...
    try {   
      ...
      while ((line = in.readLine()) != null) {
        ...
        if (line.startsWith("process")) {
          ...
          processVector.addElement(new sProcess(cputime, ioblocking,priority, 0, 0, 0));
        }
...
//      System.exit(-1);
//    }
    File f = new File("F:\\Source\\Repos\\OS-labs\\Lab3\\src\\main\\resources\\scheduling.conf");
    if (!(f.exists())) {
    ...
    Init("F:\\Source\\Repos\\OS-labs\\Lab3\\src\\main\\resources\\scheduling.conf");
    if (processVector.size() < processnum) {
      ...
      while (processVector.size() < processnum) {       
        ...
        processVector.addElement(new sProcess(cputime,i*100,i,0,0,0));
        i++;
      }
    }
