  ...
  public void step()
  {
    ...
    if ( instruct.inst.startsWith( "READ" ) ) 
    {
      ...
      if ( page.physical == -1 ) 
      {
        ...
        PageFault.replacePage( memVector , virtPageNum , Virtual2Physical.pageNum( instruct.addr , virtPageNum , block ) , controlPanel,clock);
    ...
    if ( instruct.inst.startsWith( "WRITE" ) ) 
    {
      ...
      if ( page.physical == -1 ) 
      {
        ...
        PageFault.replacePage( memVector , virtPageNum , Virtual2Physical.pageNum( instruct.addr , virtPageNum , block ) , controlPanel,clock );          controlPanel.pageFaultValueLabel.setText( "YES" );
      } 
      else 
      {
        page.M = 1;
